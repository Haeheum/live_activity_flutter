class LiveActivityProperty {
  ...
  LiveActivityProperty.fromMap(Map<String, dynamic> map) {
    ...
    liveActivityState =
        LiveActivityState.values.byName(map['liveActivityState'] as String);
  }

  @override
  bool operator ==(Object other) {
    return other is LiveActivityProperty &&
        other.activityId == activityId &&
        other.liveActivityState == liveActivityState &&
        other.pushToken == pushToken;
  }

  @override
  int get hashCode {
    return Object.hash(runtimeType, activityId, pushToken, liveActivityState);
  }
}
